...
Object.defineProperty(exports, "AchievementService", {
    enumerable: true,
    get: function() {
...
let AchievementService = class AchievementService {
    ...
    async check(userId) {
        ...
        const checks = [
            ...
            [
                ...
                ()=>highPronFeedbacks.length >= 10
            ],
            [
                'GrammarGuru',
                ()=>highGrammarFeedbacks.length >= 20
            ],
            [
                'Polyglot',
                ()=>vocabCount >= 200
    ...
    async unlock(userId, achievementCode) {
        ...
        if (!achievement) {
            ...
            await this.prisma.xpTransaction.create({
                data: {
                    ...
                    reason: `Achievement: ${created.title}`
                }
            });
    ...
    constructor(prisma){
        this.prisma = prisma;
        this.logger = new _common.Logger(AchievementService.name);
        this.achievements = [
            {
                code: 'FirstSteps',
                title: 'First Steps',
            ...
            {
                code: 'PerfectPronunciation',
                title: 'Perfect Pronunciation',
                description: 'Achieve 90%+ pronunciation score in 10 conversations',
                xpReward: 300,
                rarity: 'rare'
            },
            {
                code: 'GrammarGuru',
                title: 'Grammar Guru',
                description: 'Complete 20 conversations with grammar score above 80%',
                xpReward: 250,
                rarity: 'uncommon'
            },
            {
...
AchievementService = _ts_decorate([
