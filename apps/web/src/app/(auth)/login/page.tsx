      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full space-y-8">
        <div className="text-center space-y-4 animate-fade-down">
          ...
          <div className="space-y-1.5">
            <h1 className="heading-xl text-gradient-accent">VoxSpeak</h1>
            <p className="body-text">Your AI English speaking coach</p>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-divider bg-surface-2 accent-primary"
              />
              <span className="text-xs text-text-secondary">Remember me</span>
            </label>
            <Link href="/forgot-password" className="btn-ghost text-xs text-primary">
              Forgot password?
            </Link>
          </div>
